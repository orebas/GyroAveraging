...
GyroAverage-OpenCL: GyroAverage.cpp ga.h 
	$(CPP) GyroAverage.cpp  -O3  -I. -fopenmp -march=native -o GyroAverage-OpenCL -DVIENNACL_WITH_OPENCL -lOpenCL -I/usr/include/boost169 /usr/lib64/libboost_timer.so

GyroAverage-CPU: GyroAverage.cpp ga.h
	$(CPP) GyroAverage.cpp  -O3  -I. -fopenmp -march=native -o GyroAverage-CPU  -lOpenCL -I/usr/include/boost169 /usr/lib64/libboost_timer.so

GyroAverage-CUDA: GyroAverage.cu ga.h
